...
class Incite:
    ...
    def __init__(self, tokenizer: CLIPTokenizer, text_encoder: CLIPTextModel):
        self.conditioning_provider = ConditioningProvider(tokenizer=tokenizer, text_encoder=text_encoder)
    ...
    def _get_conditioning_for_blend(self, blend: Blend):
        ...
        conditioning = ConditioningProvider.apply_embedding_weights(conditionings_to_blend.unsqueeze(0),
                                                                    blend.weights,
